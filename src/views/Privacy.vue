  ...
  <div class="privacy-page">
    ...
    <div class="privacy-container">
      ...
      <div class="privacy-header">
        ...
        <p class="intro">
          At Elite Barber Shop, we are committed to protecting your privacy and ensuring the security of your personal information. 
      ...
      <div class="privacy-content">
        ...
        <section id="information-collection" class="privacy-section">
          ...
          <ul>
            ...
            <li><strong>Appointment Information:</strong> Service preferences, appointment history, special requests</li>
            ...
            <li><strong>Communication Records:</strong> Messages, reviews, feedback, and customer service interactions</li>
          </ul>
        ...
        <section id="information-use" class="privacy-section">
          ...
          <ul>
            ...
            <li>Customize services based on your preferences</li>
          </ul>
          ...
          <ul>
            ...
            <li>Notify you about new services or special events</li>
        ...
        <section id="information-sharing" class="privacy-section">
          ...
          <ul>
            ...
            <li>Protect the rights, property, or safety of our customers</li>
        ...
        <section id="data-security" class="privacy-section">
          ...
          <p>All payment transactions are processed through PCI DSS compliant payment processors. We do not store complete credit card information on our servers.</p>
        </section>
        ...
        <section id="data-retention" class="privacy-section">
          ...
          <p>When personal information is no longer needed, we securely delete or anonymize it in accordance with our data retention policies.</p>
        </section>

        <!-- Children's Privacy -->
        <section id="children-privacy" class="privacy-section">
          <h2>8. Children's Privacy</h2>
          <p>Our services are not intended for children under the age of 13. We do not knowingly collect personal information from children under 13. If we become aware that we have collected personal information from a child under 13, we will take steps to delete such information promptly.</p>
        ...
        <section id="contact-us" class="privacy-section">
          ...
          <div class="contact-info">
            <div class="contact-method">
              <h4>Email</h4>
              <p><a href="mailto:privacy@elitebarbershop.com">privacy@elitebarbershop.com</a></p>
            </div>
